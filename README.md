...
Web-app sencilla y responsive para convertir números entre sistemas de numeración.
...
No necesita instalación ni dependencias. Abre `index.html` en un navegador moderno.
